...
"""
    ...
    with open('tmp/calibrate_lagoon_stirrer.py', 'w') as script_file:
        script_file.write(script_content)
    print("Script generated and stored to tmp/calibrate_lagoon_stirrer.py")

def write_speed_frac_to_file(speed_frac, exp_name):
    file_path = f'experiments/{exp_name}/lagoon_stirrer_speed_frac.txt'
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        print("Usage: python calibration_lagoon_stirrer.py <speed_frac>")
        sys.exit(1)
